...
public final class TerminalSession extends TerminalOutput {
    ...
    private static FileDescriptor wrapFileDescriptor(int fileDescriptor) {
        ...
        try {
            ...
            Log.e(EmulatorDebug.LOG_TAG, "Error accessing FileDescriptor#descriptor private field", e);
            System.exit(1);
        }
        return result;
    }
    ...
    final Handler mMainThreadHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            if (msg.what == MSG_NEW_INPUT && isRunning()) {
                ...
                try{
                    byte[] bytesToWrite = exitDescription.getBytes("UTF-8"); 
    ...
    public void finishIfRunning() throws Exception {
        if (isRunning()) {
            
            try {
                android.os.Process.killProcess(mShellPid);
