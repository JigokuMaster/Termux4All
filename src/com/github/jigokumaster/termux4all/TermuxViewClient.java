...
import com.github.jigokumaster.termux4all.TermuxService;
...
public  final class TermuxViewClient implements TerminalViewClient {
    ...
    public boolean onKeyDown(int keyCode, KeyEvent e, TerminalSession currentSession) {
		...
		} else if (TerminalView.isCtrlPressed(e) && TerminalView.isAltPressed(e)) {
    ...
    public boolean readControlKey() {
        return (mActivity.mExtraKeysView != null && mActivity.mExtraKeysView.readSpecialButton(ExtraKeysView2x.SpecialButton.CTRL)) || mVirtualControlKeyDown;
    }

    @Override
    public boolean readAltKey() {
        return (mActivity.mExtraKeysView != null && mActivity.mExtraKeysView.readSpecialButton(ExtraKeysView2x.SpecialButton.ALT));
    }
